...
heroImage: /images/uploads/tes-speed.png
tags:
  - Network
  - Troubleshoot
  - Winbox
...
# Copy-paste friendly | WinBox GUI | No terminal

## PRASYARAT
[ ] Backup: System → Backup → Save
[ ] Safe Mode: Aktifkan (ikon gembok hijau)
[ ] PCQ Types: Queues → Queue Types → Pastikan ada pcq-download & pcq-upload
[ ] Info Network: WAN=ether1-wan, LAN subnet=192.168.45.0/24 (sesuaikan)
...
## VERIFIKASI
[ ] Mangle: 2 rules (download-pcq, upload-pcq)
[ ] Queue Tree: 2 rules (PCQ-DOWNLOAD, PCQ-UPLOAD)
[ ] Simple Queues: Individual queues tetap ada + Z-CATCHALL di bawah
[ ] System → Resources: CPU <70%, Memory >30MB
